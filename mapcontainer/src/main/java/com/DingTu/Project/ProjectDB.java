...
public class ProjectDB {
    ...
    public  ProjectExplorer GetProjectExplorer(){return this.m_ProjectExplorer;}

    //图层管理器
    private LayerExplorer m_LayerExplorer = null;
    public LayerExplorer GetLayerExplorer(){return this.m_LayerExplorer;}

    //底图管理器
    private BKLayerExplorer m_BKLayerExplorer = null;
    public BKLayerExplorer GetBKLayerExplorer(){return this.m_BKLayerExplorer;}

    //图层渲染器
    private LayerRenderExplorer m_LayerRenderExplorer = null;
    public LayerRenderExplorer GetLayerRenderExplorer()
    {
        if (this.m_LayerRenderExplorer==null)this.m_LayerRenderExplorer=new LayerRenderExplorer();
